                ...
                <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                            <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>Hello ${user}!</strong></h1><p style="Margin-top: 20px;Margin-bottom: 20px;">&nbsp;<br />
                            We have processed new videos for your search request for keyword "${searchWord}" with the requested filters. Please do a&nbsp;search again to find new results.</p>
                        </div>
                    </div>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                            <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #80bf2e;font-family: Ubuntu, sans-serif;" href="http://lmmsproject.tk">Visit web site</a><![endif]>
                            <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://test.com" style="width:144px" arcsize="9%" fillcolor="#80BF2E" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Go To web<br>
                            site</center></v:textbox></v:roundrect><![endif]--></div>
                    </div>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                            <p style="Margin-top: 0;Margin-bottom: 0;"><em>Best Regards,</em></p><p style="Margin-top: 20px;Margin-bottom: 20px;"><em>LMMSProject.tk</em></p>
                        </div>
                    </div>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                            <p class="size-13" style="Margin-top: 0;Margin-bottom: 0;font-size: 13px;line-height: 21px;" lang="x-size-13"><em>This is an automatically generated email &#8211; please do not reply to it</em></p>
                        </div>
                    </div>
